...
import { signOut as signOutServer } from '@/features/authentication'
...
export function DashboardPage({ currentSession }: DashboardPageProps) {
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-muted-foreground">
                  ...
                  <span className="text-sm">{user.updatedAt ? formatDate(user.updatedAt) : 'N/A'}</span>
                </div>
              </div>
            </CardContent>
          </Card>
